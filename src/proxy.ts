...
export const config = {
  ...
  matcher: ["/((?!api/auth|api/share|api/health|api/encargos|auth|share|encargos|manifest\\.json|sw\\.js|_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)"],
};
